...
from blog.models import FileItem
from cpop.settings import AWS_UPLOAD_BUCKET, AWS_UPLOAD_SECRET_KEY, AWS_UPLOAD_REGION, AWS_UPLOAD_ACCESS_KEY_ID
...
class FilePolicyAPI(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        """
        file_obj = FileItem.objects.create(name=filename_req)
        file_obj_id = file_obj.id
        upload_start_path = "media/{username}/{file_obj_id}/".format(
